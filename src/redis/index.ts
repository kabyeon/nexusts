/**
 * `nexus/redis` — runtime-aware Redis-compatible key/value client.
 *
 * Public API:
 ...
 *
 * Same API across runtimes — `nexus/session`, `nexus/cache`, and
 * `nexus/queue` (where applicable) all use the `RedisClient`
