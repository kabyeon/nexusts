...
이 문서는 NexusTS v0.8.1와 [AdonisJS v6](https://adonisjs.com)를 비교하여
...
| Feature flags | ❌ DIY | ✅ `@nexusts/feature-flag` | Rollout, allowlist, denylist, `@FeatureFlag` 데코레이터. v0.8.1 출시. |
