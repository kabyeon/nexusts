...
> 분석 일자: 2026-06-24 · 기준: NexusTS **v0.8.0**, Wasp **Launch Week #12 / TS Spec**

This document compares [NexusTS](https://github.com/nexus-ts/nexusts) v0.8.0
...
| Category | Wasp (TS Spec) | NexusTS v0.8.0 |
| --- | --- | --- |
