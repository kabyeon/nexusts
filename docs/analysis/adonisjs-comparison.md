...
This document compares NexusTS v0.8.1 against [AdonisJS v6](https://adonisjs.com)
...
| Feature flags | ❌ DIY | ✅ `@nexusts/feature-flag` | Rollout, allowlist, denylist, `@FeatureFlag` decorator. Shipped v0.8.1. |
...
**Headline**: NexusTS v0.8.1 covers **every** AdonisJS v6 battery
...
### v0.8.1 — FeatureFlagModule (shipped)
...
The v0.8.1 release **closes every AdonisJS v6 battery gap**. A team
